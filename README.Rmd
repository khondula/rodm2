...
The data to upload must have a "Timestamp column" formatted as YYYY-MM-DD HH:MM:SS and column names that are controlled vocabulary variable names (use a tibble to allow for spaces in column names).

```{r, echo = FALSE}
ts_data <- tibble::tibble(Timestamp = "2018-06-27 13:55:00",
...
db_insert_results_ts(db = dblite, # database connection
                     ...
                     variables = vars_list, 
                     sampledmedium = "Air", 
                     actionby = "Wendy", equipment_name = "Sensor01" # optional metadata
                     )
```
